            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users_create') }}">
                        ...
                        <div class="form-group row">
                            <label for="role_register" class="col-md-4 col-form-label text-md-right">{{ __('Type') }}</label>
                            <div class="col-md-6">
                                <select  id="role_register" placeholder="choisir une categorie" name="type" class="form-select form-control" aria-label="Default select example">
                        ...
                        <div id="formation_register_row" class="form-group row d-none">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="mdp_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
